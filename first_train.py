...
from py_utils.utils import GridDataset, plot_validation_results, load_h5_to_torch, calc_grad_loss
...
if load_existing_weights and os.path.isfile(WEIGHTS_PATH):
    ...
    ValidateModel(model, test_loader, criterion, h_std, h_mean, device, epoch_label="loaded")
    ...
    ValidateModel(model, test_loader, criterion, h_std, h_mean, device, epoch_label=epochs, save_plot=True)
